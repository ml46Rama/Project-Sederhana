...
puts ("|   1.Badung      6.Jembrana        |   1.Edukasi                   |");
puts ("|   2.Denpasar    7.Karangasem      |   2.Konservasi                |");
puts ("|   3.Gianyar     8.Tabanan         |   3.Religi                    |");
puts ("|   4.Klungkung   9.Buleleng Barat  |   4.Pantai                    |");
puts ("|   5.Bangli      10.Buleleng Timur |   5.Shopping                  |");
puts ("+-------------------------------------------------------------------+");
